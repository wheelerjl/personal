...
then
    ...
    echo "      wget -O ~/Downloads/go1.20.6.linux-amd64.tar.gz https://go.dev/dl/go1.20.6.linux-amd64.tar.gz"
    echo "      sudo rm -rf /usr/local/go"
    echo "      sudo tar -C /usr/local -xzf ~/Downloads/go1.20.6.linux-amd64.tar.gz"
    echo "      rm -rf ~/Downloads/go1.20.6.linux-amd64.tar.gz"
    read -n 1 -s -r -p "  Press any key to continue"
    echo ""
fi
...
then
    ...
    echo "      sudo curl -Lo /usr/local/bin/sops https://github.com/getsops/sops/releases/download/v3.7.3/sops-v3.7.3.linux.amd64"
...
then
    ...
    echo "      sudo curl -Lo /usr/local/bin/kind https://kind.sigs.k8s.io/dl/v0.20.0/kind-linux-amd64"
...
then
    ...
    echo "      wget -O ~/Downloads/task.deb https://github.com/go-task/task/releases/download/v3.27.1/task_linux_amd64.deb"
